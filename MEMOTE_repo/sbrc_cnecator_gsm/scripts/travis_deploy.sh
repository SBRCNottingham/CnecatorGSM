...
if [[ "${TRAVIS_PULL_REQUEST}" != "false" || "${TRAVIS_REPO_SLUG}" != "NicolePearcy/sbrc_cnecator_gsm" ]]; then
...
echo "Your new report will be visible at https://NicolePearcy.github.io/sbrc_cnecator_gsm in a moment."
